...
#Cari tweet tentang topik anti-vaksin
...
#Untuk melakukan analisis sentimen menggunakan Bing di tweet Anti-Vaksin, 
...
ui = fluidPage(
  #apllication tittle
  titlePanel("Sentiment Analisis Anti-Vaksin di Twitter"),
  mainPanel(
